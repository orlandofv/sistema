...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.header = ["nome", "cabecalho", "logo", "slogan", "endereco", "contactos", "email",
                       "web", "nuit", "casas_decimais", "Licenca", "Contas"]
    ...
    def fill_table(self):
        ...
        self.sql = """select * from empresas WHERE nome like "%{}%" order by nome""".format(self.find_w.text())
    ...
    def create_toolbar(self):
        ...
        if STANDALONE is not True:
            ...
            self.new.setIcon(QIcon("icons/option.ico"))
            self.new.triggered.connect(self.set_empresa)
            self.tv.doubleClicked.connect(self.set_empresa)
        else:
    ...
    def update_data(self):
        ...
        cl = Empresa(self)
        cl.nome.setCurrentText(self.current_id)
    ...
    def removerow(self):
        ...
        if QMessageBox.question(self, "Pergunta", str("Deseja eliminar o registo %s?") % self.current_id,
            ...
            sql = """delete from empresas WHERE nome = "{codigo}" """.format(codigo=str(self.current_id))
