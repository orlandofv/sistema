...
class MainWindow(QMainWindow):
    ...
    def fill_table(self):
        ...
        from hospedes WHERE nome like "%{nome}%" """.format(nome=self.find_w.text())
    ...
    def removerow(self):
        ...
        if self.current_id != "CL20181111111":
            if QMessageBox.question(self, "Pergunta", str("Deseja eliminar o registo %s?") % self.current_id,
                ...
                sql = """delete from hospedes WHERE cod = "{codigo}" """.format(codigo=str(self.current_id))
                ...
                try:
                    ...
                    QMessageBox.warning(self, "Erro", "Impossivel apagar hospede.")
        else:
            QMessageBox.warning(self, "Erro", "Hospede não pode ser apagado.")
    ...
    def imprime_lista(self):
        ...
        html = "<center> <h2> Lista de Hóspedes </h2> </center>"
        html += "<hr/>"
