...
class Lista_de_Contas(QMainWindow):
    def __init__(self, parent=None):
        super(Lista_de_Contas, self).__init__(parent)
    ...
    def fill_table(self):
        ...
        FROM contas WHERE  contas.nome_banco like "%{nome}%" 
        OR contas.conta like "%{nome}%" or contas.nib like "%{nome}%" or contas.swift like "%{nome}%"
        or contas.endereco like "%{nome}%" 
    ...
    def removerow(self):
        ...
        if self.current_id != "CL20181111111":
            if QMessageBox.question(self, "Pergunta", str("Deseja eliminar o registo %s?") % self.current_id,
                ...
                sql = """delete from contas WHERE cod = "{codigo}" """.format(codigo=str(self.current_id))
            ...
            QMessageBox.warning(self, "Erro", "Conta não pode ser apagado.")
    ...
    def imprime_lista(self):
        ...
        html = "<center> <h2> Lista de Contas </h2> </center>"
        html += "<hr/>"
...
#
    helloPythonWidget = Lista_de_Contas()
