...
class ListaDeAlunos(QMainWindow):
    def __init__(self, parent=None):
        super(ListaDeAlunos, self).__init__(parent)
    ...
    def fill_table(self):
        ...
        self.sql = """select cod, nome, apelido, nacionalidade, email, contactos, numero_id, obs  
        from alunos WHERE nome like "%{nome}%" """.format(nome=self.find_w.text())
    ...
    def removerow(self):
        ...
        if self.current_id != "CL20181111111":
            if QMessageBox.question(self, "Pergunta", str("Deseja eliminar o registo %s?") % self.current_id,
                ...
                sql = """delete from alunos WHERE cod = "{codigo}" """.format(codigo=str(self.current_id))
                ...
                try:
                    ...
                    QMessageBox.warning(self, "Erro", "Impossivel apagar aluno.")
        else:
            QMessageBox.warning(self, "Erro", "Aluno não pode ser apagado.")
    ...
    def imprime_lista(self):
        ...
        html = "<center> <h2> Lista de Alunos </h2> </center>"
        html += "<hr/>"
...
#
#     helloPythonWidget = ListaDeAlunos()
